...
import openfl.*;
import compat.*;
class Class_171 extends Attack {
    ...
    @:allow(code) override function do_Attack(param1:Poke) {
        ...
        var _loc2_ = param1.check_Effects(Class_828);
        if (_loc2_ != null) {
            _loc3_ = new Class_22(Class_22.const_11);
            _loc2_.remove_Me();
            return;
        }
        param1.add_Effect(new Class_829(param1, Class_171.name_1));
    }

    @:allow(code) override function get_My_Attack_Animation():Class_16 {
        return new Class_197(var_2, new Do_Lucky_Chant());
    }
