...
class Class_970 extends Class_877 {
    ...
    public function new(param1:Class_875, param2:Class_1104, param3:String, param4:Int) {
        this.var_111 = param2;
        this.var_362 = param3;
        this.var_215 = param4;
        this.var_3 = param1;
    ...
    @:allow(code) override function init() {
        ...
        gfx.actual.moveText.text = this.var_111.myProfile.name + " is trying to learn " + this.var_362 + ".";
    }
