...
class Class_1050 extends Class_877 {
    ...
    @:allow(code) override function init() {
        ...
        if (this.var_3.currentProfile.var_123 < 22 && this.var_3.currentProfile.levelUnlocked < 22) {
    ...
    function method_229() {
        SoundMixer.stopAll();
        var _loc1_:Sound = new CasinoMusic();
        var _loc2_ = _loc1_.play(0, 10);
        var _loc3_ = new SoundTransform(Class_1.var_25);
        _loc2_.soundTransform = _loc3_;
    }
    ...
    @:allow(code) override function get_Graphic():GfxMovieClip {
        return new Movie_Scene_Intro_22();
    }
