...
class Class_1058 extends Class_877 {
    ...
    @:allow(code) override function init() {
        ...
        if (this.var_3.currentProfile.var_123 < 20 && this.var_3.currentProfile.levelUnlocked < 20) {
    ...
    function method_307() {
        SoundMixer.stopAll();
        var _loc1_:Sound = new CeladonCityMusic();
    ...
    @:allow(code) override function run(param1:Event = null):Bool {
        if (false) {
            ...
            gfx.nicknameText.text = this.var_3.currentProfile.var_7 + "! Nice to meet you again!";
        }
        return false;
    }
    ...
    @:allow(code) override function get_Graphic():GfxMovieClip {
        return new Movie_Scene_Intro_20();
    }
