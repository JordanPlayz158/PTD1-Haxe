...
class Class_286 extends Class_16 {


    @:allow(code) var gfx:GfxMovieClip;

    @:allow(code) var var_475:GfxMovieClip;
    ...
    @:allow(code) override function run() {
        if (this.gfx.y == 0 && this.gfx.x == 0 && !this.var_29) {
            this.var_29 = true;
            this.var_475 = new Gfx_Hit_Scratch();
            var_1.addChild(this.var_475);
        }
        else if (this.var_475 != null && this.var_475.currentLabel == "end") {
            this.remove_Me();
        }
        else {
    ...
    @:allow(code) override function remove_Me() {
        ...
        if (this.var_475 != null) {
            var_1.removeChild(this.var_475);
            this.var_475 = null;
        }
        this.gfx = null;
