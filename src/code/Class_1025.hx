...
class Class_1025 extends Class_877 {
    ...
    @:allow(code) override function init() {
        ...
        if (this.var_3.currentProfile.var_123 < 5 && this.var_3.currentProfile.levelUnlocked < 5) {
    ...
    @:allow(code) override function run(param1:Event = null):Bool {
        if (false) {
            ...
            gfx.your_name.text = this.var_3.currentProfile.var_7 + "...";
        }
        else if (false) {
            method_5("095");
        }
    ...
    @:allow(code) override function get_Graphic():GfxMovieClip {
        return new Movie_Scene_Intro_5();
    }
