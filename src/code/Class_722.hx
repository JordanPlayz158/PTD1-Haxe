...
import openfl.*;
import compat.*;
class Class_722 extends Class_194 {
    ...
    @:allow(code) override function do_Attack(param1:Poke) {
        ...
        var _loc3_:Class_853 = new Class_871(cast(var_2.my_Parent, Class_875), param1, var_2, this, _loc2_);
        _loc3_.x = var_2.x;
        _loc3_.y = var_2.y;
        var_2.send_Msg(["add_path_effect", _loc3_]);
    }
