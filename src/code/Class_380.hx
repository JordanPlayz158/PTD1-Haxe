...
class Class_380 extends Class_16 {
    ...
    @:allow(code) override function init() {
        ...
        this.var_18 = new Aqua_Tail();
        this.var_18.gotoAndPlay(this.var_8.dir);
