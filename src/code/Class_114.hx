...
import openfl.*;
import compat.*;
class Class_114 extends Attack {
    ...
    @:allow(code) override function do_Attack(param1:Poke) {
        ...
        var_2.add_Effect(new Class_205(var_2, 16711680, 0.7, Class_114.name_1));
        var_2.add_Effect(new Class_805(var_2, Class_114.name_1));
    }
