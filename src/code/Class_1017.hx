...
class Class_1017 extends Class_877 {
    ...
    @:allow(code) override function init() {
        ...
        if (this.var_3.currentProfile.var_123 < 29 && this.var_3.currentProfile.levelUnlocked < 29) {
    ...
    @:allow(code) override function get_Graphic():GfxMovieClip {
        return new Movie_Scene_Intro_29();
    }

    @:allow(code) override function remove_Me() {
        super.remove_Me();
        if (this.var_3.currentProfile.badges < 6) {
            this.var_3.currentProfile.badges = 6;
        }
