...
import openfl.*;
import compat.*;
class Class_605 extends Class_194 {
    ...
    @:allow(code) override function do_Attack(param1:Poke) {
        ...
        if (param1.check_Effects(Class_200) == null && !param1.myProfile.is_Type(Class_13.const_2) && !param1.myProfile.is_Type(Class_13.const_7)) {
            _loc2_ = method_3(param1, this.get_Move_Power(), true);
            _loc3_ = new Class_200(param1, _loc2_);
    ...
    @:allow(code) override function get_My_Attack_Animation():Class_16 {
        return new Class_733(var_2, new Do_Poison_Powder());
    }
