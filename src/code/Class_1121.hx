...
class Class_1121 extends Class_949 {
    ...
    @:allow(code) override function start_Level(param1:Bool = true, param2:ASAny = false, param3:Class_7 = null) {
        ...
        if (param1) {
            method_10(new Class_1104(this, this.method_22(Class_13.const_51)), 1);
            method_10(new Class_1104(this, this.method_22(Class_13.const_16)), 2);
            method_10(new Class_1104(this, this.method_22(Class_13.const_21)), 3);
        }
    }

    function method_22(param1:Int):Class_6 {
        var _loc2_ = new Class_6();
        if (param1 == Class_13.const_51) {
            _loc2_.num = Class_13.const_51;
            Class_13.method_2(_loc2_);
            _loc2_.level = 25;
            _loc2_.move1 = Class_9.var_162;
            _loc2_.var_13 = 1;
        }
        else if (param1 == Class_13.const_16) {
            _loc2_.num = Class_13.const_16;
            Class_13.method_2(_loc2_);
            _loc2_.level = 25;
            _loc2_.move1 = Class_9.var_141;
            _loc2_.var_13 = 1;
        }
        else if (param1 == Class_13.const_21) {
    ...
    override function get_Win_Popup():Class_877 {
        this.var_68[4] = true;
        var _loc2_:Class_875 = new Class_1121(currentProfile, my_Parent, this.var_68);
        end_Level(_loc2_);
        return null;
    }
