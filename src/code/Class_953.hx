...
class Class_953 extends Class_875 {
    ...
    override function get_Level_BG():GfxMovieClip {
        return new Gfx_Level_41();
    }

    override function get_Intro_Popup():Class_877 {
        return new Class_1077(this);
    }
    ...
    override function get_Lost_Popup():Class_877 {
        return new Class_986(this, new Popup_Lost_40_2());
    }
    ...
    @:allow(code) override function i_Win():Class_877 {
        ...
        end_Level(new Class_955(currentProfile, my_Parent));
        return null;
    }
}
