...
class Class_966 extends Class_875 {
    ...
    override function get_Win_Popup():Class_877 {
        this.var_68[3] = true;
        var _loc2_:Class_875 = new Class_966(currentProfile, my_Parent, this.var_68);
        end_Level(_loc2_);
        return null;
    }
}
