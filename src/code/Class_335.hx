...
class Class_335 extends Class_16 {
    ...
    @:allow(code) function do_Flinch() {
        Attack.do_Flinch(this.var_14, 10, Attack.ATTACK_TIME, var_1, null, var_12, true);
    }
