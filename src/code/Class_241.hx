...
class Class_241 extends Class_16 {
    ...
    @:allow(code) override function init() {
        ...
        this.var_18 = new Fangs_Poison();
        this.var_17.addChild(this.var_18);
    ...
    @:allow(code) override function remove_Me() {
        ...
        if (var_1.check_Effects(Class_200) == null && !var_1.myProfile.is_Type(Class_13.const_2) && !var_1.myProfile.is_Type(Class_13.const_7)) {
            ...
            if (_loc1_ <= 30) {
                _loc2_ = new Class_200(var_1, this.var_696);
