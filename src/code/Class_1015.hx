...
class Class_1015 extends Class_877 {
    ...
    @:allow(code) override function init() {
        ...
        if (this.var_3.currentProfile.var_123 < 16 && this.var_3.currentProfile.levelUnlocked < 16) {
    ...
    @:allow(code) override function get_Graphic():GfxMovieClip {
        return new Movie_Scene_Intro_16();
    }

    @:allow(code) override function remove_Me() {
        super.remove_Me();
        gfx.removeEventListener(Event.FRAME_CONSTRUCTED, this.method_8);
