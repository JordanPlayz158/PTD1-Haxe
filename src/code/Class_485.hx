...
import openfl.*;
import compat.*;
class Class_485 extends Class_194 {
    ...
    @:allow(code) override function do_Attack(param1:Poke) {
        ...
        var _loc4_:Class_16;
        (_loc4_ = new Class_259(var_2, param1, _loc2_, _loc3_)).var_12 = var_12;
        var_2.add_Effect(_loc4_);
    }

    @:allow(code) override function get_My_Attack_Animation():Class_16 {
        var_2.add_Effect(new Class_197(var_2, new Do_Water_Pulse_Ring()));
