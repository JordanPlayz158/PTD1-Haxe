...
class Class_674 extends Class_194 {
    ...
    @:allow(code) override function get_Accurary():Int {
        ...
        else if (var_2.check_Effects(Class_789) != null) {
            _loc1_ = 50;
        }
        return _loc1_;
    }
