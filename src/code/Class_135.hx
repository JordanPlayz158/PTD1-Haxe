...
import openfl.*;
import compat.*;
class Class_135 extends Attack {
    ...
    @:allow(code) override function do_Attack(param1:Poke) {
        ...
        if (_loc2_ != null) {
            ...
            param1.add_Effect(new Class_792(param1, Class_135.name_1));
        }
        param1.add_Effect(new Class_205(param1, 16777215, 0.3, Class_135.name_1));
        param1.add_Effect(new Class_816(param1, Class_135.name_1));
    }
