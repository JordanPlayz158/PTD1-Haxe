...
class Class_1045 extends Class_877 {
    ...
    @:allow(code) override function init() {
        ...
        if (this.var_3.currentProfile.var_123 < 34 && this.var_3.currentProfile.levelUnlocked < 34) {
    ...
    function method_199() {
        SoundMixer.stopAll();
        var _loc1_:Sound = new CinnabarMusic();
    ...
    function method_275() {
        SoundMixer.stopAll();
        var _loc1_:Sound = new PalletMusic();
        var _loc2_ = _loc1_.play(0, 10);
        var _loc3_ = new SoundTransform(Class_1.var_25);
        _loc2_.soundTransform = _loc3_;
    }
    ...
    @:allow(code) override function get_Graphic():GfxMovieClip {
        return new Movie_Scene_Intro_34();
    }

    @:allow(code) override function remove_Me() {
        super.remove_Me();
        if (this.var_3.currentProfile.badges < 7) {
            this.var_3.currentProfile.badges = 7;
        }
