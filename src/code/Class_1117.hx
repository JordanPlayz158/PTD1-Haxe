...
class Class_1117 extends Class_949 {
    ...
    @:allow(code) override function start_Level(param1:Bool = true, param2:ASAny = false, param3:Class_7 = null) {
        ...
        if (param1) {
            method_10(new Class_1104(this, this.method_22(Class_13.const_34)), 1);
            method_10(new Class_1104(this, this.method_22(Class_13.const_31)), 2);
        }
    }

    function method_22(param1:Int):Class_6 {
        var _loc2_ = new Class_6();
        if (param1 == Class_13.const_34) {
            _loc2_.num = Class_13.const_34;
            Class_13.method_2(_loc2_);
            _loc2_.level = 27;
            _loc2_.move1 = Class_9.var_344;
            _loc2_.var_13 = 1;
        }
        else if (param1 == Class_13.const_31) {
            _loc2_.num = Class_13.const_31;
            Class_13.method_2(_loc2_);
            _loc2_.level = 27;
            _loc2_.move1 = Class_9.var_51;
            _loc2_.var_13 = 1;
        }
        _loc2_.var_40 = 0;
        _loc2_.var_35 = -1;
    ...
    @:allow(code) override function i_Win():Class_877 {
        ...
        end_Level(new Class_962(currentProfile, my_Parent));
        return null;
    }
