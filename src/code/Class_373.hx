...
class Class_373 extends Class_16 {
    ...
    public function new(param1:Poke, param2:Poke, param3:Int, param4:Attack) {
        this.var_8 = param2;
        this.var_20 = param3;
        this.var_55 = param4;
        super(param1);
    ...
    @:allow(code) override function run() {
        if (this.gfx.y == 0 && this.gfx.x == 0 && !this.var_29) {
            ...
            var_1.add_Effect(new Class_838(var_1, null, 18));
            Attack.do_Flinch(var_1, 30, Attack.ATTACK_TIME, this.var_8, this.var_55, var_12, true);
            this.remove_Me();
        }
        else {
