...
import openfl.*;
import compat.*;
class Class_870 extends Class_853 {
    ...
    public function new(param1:Class_875, param2:Poke, param3:Poke, param4:Class_194) {
        this.var_55 = param4;
        this.var_14 = param2;
        super(param1, new Do_Aura_Sphere(), 0, param3);
        gfx.gotoAndStop(1);
        this.method_7();
    }
    ...
    @:allow(code) override function onCollision(param1:Poke) {
        if (param1.check_Effects(Class_847) != null) {
            return;
        }
        var _loc2_ = this.var_55.method_3(param1);
        param1.add_Effect(new Class_847(param1, Attack.ATTACK_TIME));
