...
class Class_1103 extends Class_877 {
    ...
    @:allow(code) override function init() {
        ...
        var _loc1_ = Std.downcast(this.var_3, Class_968);
        var _loc2_ = 0;
        while (_loc2_ < 7) {
    ...
    @:allow(code) override function mouse_Down(param1:MouseEvent = null):Bool {
        ...
        if (param1.target != null && Std.is(param1.target, GfxMovieClip)) {
            ...
            if (_loc2_.name == "butt_next") {
                ...
                if (false) {
                    _loc3_ = Std.downcast(this.var_3, Class_968);
                ...
                if (false) {
                    _loc3_ = Std.downcast(this.var_3, Class_968);
                    _loc4_ = new Class_1121(this.var_3.currentProfile, this.var_3.my_Parent, _loc3_.var_68);
                    send_Msg(["change_Screen", _loc4_]);
                    return true;
                }
                gfx.play();
    ...
    @:allow(code) override function get_Graphic():GfxMovieClip {
        return new Movie_Scene_Intro_17_Space_9();
    }
