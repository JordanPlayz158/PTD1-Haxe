...
class Class_998 extends Class_877 {


    @:allow(code) var var_49:GfxMovieClip;

    @:allow(code) var var_3:Class_912;

    @:allow(code) var var_276:Bool = false;

    public function new(param1:Class_912) {
        this.var_3 = param1;
        super(param1);
    }
    ...
    @:allow(code) override function get_Graphic():GfxMovieClip {
        return new Movie_Scene_Level_33_Win();
    }
