...
class Class_1010 extends Class_877 {
    ...
    @:allow(code) override function init() {
        ...
        if (this.var_3.currentProfile.var_123 < 19 && this.var_3.currentProfile.levelUnlocked < 19) {
    ...
    function method_236() {
        SoundMixer.stopAll();
        var _loc1_:Sound = new LavenderTownMusic();
        var _loc2_ = _loc1_.play(0, 10);
        var _loc3_ = new SoundTransform(Class_1.var_25);
        _loc2_.soundTransform = _loc3_;
    }
    ...
    @:allow(code) override function mouse_Down(param1:MouseEvent = null):Bool {
        ...
        if (param1.target != null && Std.is(param1.target, GfxMovieClip)) {
            ...
            if (_loc2_.name == "butt_next") {
                if (false && this.var_22 != 7) {
                    gfx.gotoAndPlay("noTr");
                    return true;
                }
                gfx.play();
                return true;
    ...
    @:allow(code) override function get_Graphic():GfxMovieClip {
        return new Movie_Scene_Intro_19();
    }
