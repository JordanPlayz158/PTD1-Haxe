...
class Class_355 extends Class_16 {
    ...
    @:allow(code) override function remove_Me() {
        ...
        if (this.var_14.var_64) {
            _loc2_ = new Class_874(cast(this.var_14.my_Parent, Class_875), this.var_433, var_12, var_1);
            _loc2_.x = this.var_14.x;
            _loc2_.y = this.var_14.y;
            this.var_14.send_Msg(["add_path_effect", _loc2_]);
        }
        var_1 = null;
        this.var_14 = null;
    }
