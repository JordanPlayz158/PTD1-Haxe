...
import openfl.*;
import compat.*;
class Class_113 extends Attack {


    static inline final name_1 = 18;

    static inline final name_2 = Std.int(126.0);
    ...
    @:allow(code) override function do_Attack(param1:Poke) {
        ...
        while (_loc5_ < _loc2_.length) {
            ...
            if (!_loc3_.check_Effects(Class_794)) {
                _loc4_ = true;
                _loc3_.add_Effect(new Class_794(_loc3_, Class_113.name_1));
            }
            _loc5_++;
        }
    }
