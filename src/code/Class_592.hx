...
import openfl.*;
import compat.*;
class Class_592 extends Class_194 {
    ...
    @:allow(code) override function do_Attack(param1:Poke) {
        ...
        var_2.add_Effect(new Class_733(var_2, new Do_Sand_Attack()));
        var _loc3_ = cast(var_2.my_Parent, Class_875);
        if (_loc3_.method_23(Class_857) != null) {
            return;
        }
        var _loc4_:Class_853 = new Class_857(_loc3_, var_2, _loc2_, var_12);
