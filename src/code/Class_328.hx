...
class Class_328 extends Class_16 {
    ...
    @:allow(code) override function remove_Me() {
        ...
        if (this.var_14.check_Effects(Class_810) == null) {
            _loc2_ = this.var_14.check_Effects(Class_803);
            if (_loc2_) {
                _loc3_ = new Class_22(Class_22.const_11);
                _loc2_.remove_Me();
            }
            else {
                this.var_14.add_Effect(new Class_810(this.var_14, Class_328.name_1));
                this.var_14.add_Effect(new Class_205(this.var_14, 6723840, 0.5, Class_328.name_1));
            }
        }
