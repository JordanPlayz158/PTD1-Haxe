...
class Class_968 extends Class_875 {
    ...
    override function get_Win_Popup():Class_877 {
        ...
        this.var_68[7] = true;
        if (true) {
            currentProfile.extraInfo = [];
        }
        if (!currentProfile.haveThisExtraInfo("sh1")) {
            currentProfile.extraInfo.push("sh1");
        }
        return new Class_1102(this);
    }
}
