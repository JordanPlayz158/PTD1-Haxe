...
class Class_1022 extends Class_877 {
    ...
    @:allow(code) override function init() {
        ...
        if (this.var_3.currentProfile.var_123 < 23 && this.var_3.currentProfile.levelUnlocked < 23) {
    ...
    function method_285() {
        SoundMixer.stopAll();
        var _loc1_:Sound = new PokeTowerMusic();
    ...
    @:allow(code) override function get_Graphic():GfxMovieClip {
        return new Movie_Scene_Intro_23();
    }
