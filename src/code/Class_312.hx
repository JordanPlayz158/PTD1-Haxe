...
class Class_312 extends Class_16 {
    ...
    @:allow(code) override function run() {
        ...
        if (this.var_512 < this.var_564 && var_15 == 0) {
            this.var_38 = new Do_Stored_Power();
        ...
        while (_loc3_ < this.var_388.length) {
            this.var_38 = this.var_388[_loc3_];
            _loc1_ = false;
            _loc2_ = false;
            if (Math.abs(this.var_38.y - this.var_284.y) < this.var_4) {
                _loc2_ = true;
                this.var_38.y = this.var_284.y;
            }
            if (Math.abs(this.var_38.x - this.var_284.x) < this.var_4) {
                _loc1_ = true;
                this.var_38.x = this.var_284.x;
            }
            if (this.var_38.y == this.var_284.y && this.var_38.x == this.var_284.x || _loc1_ && _loc2_) {
                var_1.removeChild(this.var_38);
                this.var_388.splice(_loc3_, 1);
                this.var_14.take_Damage(this.var_433, new Class_197(this.var_14, new Gfx_Hit()), var_12, false);
                _loc3_--;
            }
            else {
                if (this.var_38.y > this.var_284.y) {
                    this.var_9 = -this.var_4;
                }
                else if (this.var_38.y < this.var_284.y) {
                    this.var_9 = this.var_4;
                }
                else {
                    this.var_9 = 0;
                }
                if (this.var_38.x > this.var_284.x) {
                    this.var_10 = -this.var_4;
                }
                else if (this.var_38.x < this.var_284.x) {
                    this.var_10 = this.var_4;
                }
                else {
                    this.var_10 = 0;
