...
class Class_332 extends Class_16 {
    ...
    @:allow(code) override function remove_Me() {
        ...
        Attack.do_Flinch(var_1, 10, Attack.ATTACK_TIME, this.var_8, this.var_540, var_12, true);
        Attack.do_Burn(var_1, 10, this.var_8, this.var_540, this.var_321, var_12);
