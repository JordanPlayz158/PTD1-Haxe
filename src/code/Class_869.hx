...
import openfl.*;
import compat.*;
class Class_869 extends Class_853 {
    ...
    public function new(param1:Class_875, param2:Poke, param3:Poke, param4:Class_194) {
        this.var_55 = param4;
        this.var_14 = param2;
        super(param1, new Do_Fusion_Flare(), 0, param3);
        gfx.gotoAndStop(1);
        this.method_7();
    }
    ...
    @:allow(code) override function onCollision(param1:Poke) {
        ...
        var _loc4_ = 0;
        if (param1.check_Effects(Class_846) != null) {
            return;
        }
        var _loc2_ = this.var_55.method_3(param1);
        if (param1.check_Effects(Class_826) != null || var_65.check_Effects(Class_788) != null) {
            _loc2_ = Std.int(_loc2_ * 0.5);
        }
        if (var_65.check_Effects(Class_789) != null) {
            _loc2_ = Std.int(_loc2_ * 1.5);
        }
        param1.add_Effect(new Class_846(param1, Attack.ATTACK_TIME));
        if (Std.is(var_65, Class_1104)) {
            ...
            while (_loc4_ < var_2.towerList.length) {
                ...
                if (_loc3_.myProfile["move" + _loc3_.myProfile.moveSelected] == Class_9.var_513) {
                    _loc2_ *= 2;
                    break;
                }
                _loc4_++;
