...
class Class_208 extends Class_16 {
    ...
    @:allow(code) override function run() {
        ...
        while (_loc3_ < this.var_388.length) {
            ...
            if (this.gfx.y == this.var_284.y && this.gfx.x == this.var_284.x || _loc1_ && _loc2_) {
                ...
                this.var_14.take_Damage(Std.int(this.var_433 / 2), new Class_197(this.var_14, new Gfx_Hit()), var_12, false);
                _loc3_--;
            }
            else {
