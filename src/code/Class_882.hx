...
class Class_882 extends _Obj {


    static inline final const_284 = 36;

    static inline final const_291 = 31;
    ...
    @:allow(code) function init() {
        this.gfx_BG = new Gfx_Screen_Level_Select_Chapter_7();
    ...
    @:allow(code) function method_19() {
        ...
        var _loc2_ = Class_882.const_291;
        while (_loc2_ <= Class_882.const_284) {
    ...
    @:allow(code) override function mouse_Down(param1:MouseEvent = null):Bool {
        ...
        if (Std.is(param1.target, GfxMovieClip)) {
            ...
            _loc5_ = Class_882.const_291;
            while (_loc5_ <= Class_882.const_284) {
