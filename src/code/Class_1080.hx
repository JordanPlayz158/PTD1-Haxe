...
class Class_1080 extends Class_877 {
    ...
    @:allow(code) override function init() {
        ...
        var _loc1_ = Std.downcast(this.var_3, Class_956);
        if (!_loc1_.var_68[1]) {
    ...
    @:allow(code) override function mouse_Down(param1:MouseEvent = null):Bool {
        ...
        if (param1.target != null && Std.is(param1.target, GfxMovieClip)) {
            ...
            if (_loc2_.name == "butt_next") {
                ...
                if (false) {
                    _loc3_ = Std.downcast(this.var_3, Class_956);
                    _loc4_ = new Class_954(this.var_3.currentProfile, this.var_3.my_Parent, _loc3_.var_68);
    ...
    @:allow(code) override function get_Graphic():GfxMovieClip {
        return new Movie_Scene_Intro_17_Space_2();
    }
