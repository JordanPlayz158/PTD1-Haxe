...
class Class_280 extends Class_16 {
    ...
    @:allow(code) override function run() {
        ...
        if (this.var_512 < this.var_564) {
            this.gfx = new Hit_Bubble();
            this.var_388.push(this.gfx);
            var _loc4_:ASAny = Math.random() + 0.2;
            this.gfx.scaleY = Math.random() + 0.2;
            this.gfx.scaleX = _loc4_;
            this.gfx.x = Math.random() * 7;
            this.gfx.y = Math.random() * 7;
    ...
    @:allow(code) override function remove_Me() {
        ...
        if (this.var_14.check_Effects(Class_809) == null) {
            ...
            if (_loc2_ <= 10) {
                _loc3_ = this.var_14.check_Effects(Class_806);
                if (_loc3_) {
                    _loc4_ = new Class_22(Class_22.const_11);
                    _loc3_.remove_Me();
                }
                else {
                    this.var_14.add_Effect(new Class_809(this.var_14, Class_280.name_1));
                    this.var_14.add_Effect(new Class_205(this.var_14, 39423, 0.5, Class_280.name_1));
                }
            }
        }
