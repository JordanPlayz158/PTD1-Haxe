...
class Class_200 extends Class_16 {
    ...
    @:allow(code) override function run() {
        ...
        if (this.var_120 == this.var_249) {
            this.var_120 = 0;
            trace("took poison damage of " + this.var_433);
            var_1.take_Damage(this.var_433, new Class_197(var_1, new Hit_Poison()), var_12);
        }
    }
