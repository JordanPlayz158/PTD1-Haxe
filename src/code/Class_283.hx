...
class Class_283 extends Class_16 {
    ...
    @:allow(code) override function run() {
        if (this.gfx.y == 0 && this.gfx.x == 0 && !this.var_29) {
            this.var_29 = true;
            this.var_18.gotoAndPlay("bite");
        }
        else if (this.var_18.currentLabel == "end") {
            this.remove_Me();
        }
        else {
    ...
    @:allow(code) override function remove_Me() {
        ...
        Attack.do_Flinch(var_1, 10, Attack.ATTACK_TIME, this.var_8, null, var_12, true);
        if (var_1.check_Effects(Class_796) == null && !var_1.myProfile.is_Type(Class_13.const_18)) {
            _loc1_ = Std.int(Math.random() * 100 + 1);
            if (_loc1_ <= 10) {
                _loc2_ = new Class_796(var_1, 0);
