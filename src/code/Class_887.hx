...
class Class_887 extends _Obj {


    static inline final const_284 = 25;

    static inline final const_291 = 21;
    ...
    @:allow(code) function init() {
        this.gfx_BG = new Gfx_Screen_Level_Select_Chapter_5();
    ...
    @:allow(code) function method_19() {
        ...
        var _loc2_ = Class_887.const_291;
        while (_loc2_ <= Class_887.const_284) {
    ...
    @:allow(code) override function mouse_Down(param1:MouseEvent = null):Bool {
        ...
        if (Std.is(param1.target, GfxMovieClip)) {
            ...
            _loc5_ = Class_887.const_291;
            while (_loc5_ <= Class_887.const_284) {
