...
class Class_995 extends Class_877 {


    @:allow(code) var var_3:Class_911;

    public function new(param1:Class_911) {
        this.var_3 = param1;
        super(param1);
    }
    ...
    @:allow(code) override function init() {
        ...
        if (this.var_3.currentProfile.levelUnlocked < 14) {
    ...
    @:allow(code) override function mouse_Down(param1:MouseEvent = null):Bool {
        ...
        if (param1.target != null && Std.is(param1.target, GfxMovieClip)) {
            ...
            if (_loc2_.name == "butt_next") {
                if (false) {
                    if (this.var_3.var_660 != null && (this.var_3.currentProfile.clevel1CodeUsed.length < 3 || this.var_3.currentProfile.clevel1CodeUsed.charAt(2) != "1")) {
                        gfx.play();
                    }
                    else {
    ...
    function method_327() {
        ...
        _loc1_.num = Class_13.const_149;
        _loc1_.level = 1;
        _loc1_.var_40 = 0;
        _loc1_.move1 = Class_9.var_155;
        _loc1_.move2 = Class_9.var_102;
        _loc1_.move3 = Class_9.var_57;
        _loc1_.move4 = 0;
        _loc1_.moveSelected = 1;
        _loc1_.var_13 = 3;
        _loc1_.var_301 = "Farfetch\'d";
    ...
    function method_237() {
        SoundMixer.stopAll();
        var _loc1_:Sound = new VermillionMusic();
