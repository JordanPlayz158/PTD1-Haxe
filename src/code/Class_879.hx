...
class Class_879 extends _Obj {
    ...
    @:allow(code) var var_205:Class_1104;

    @:allow(code) var var_450:Class_875;
    ...
    public function new(param1:Class_1104, param2:Class_878, param3:_Obj, param4:Class_6 = null) {
        super(param3);
        this.var_205 = param1;
    ...
    @:allow(code) function init() {
        ...
        this.method_88();
        this.method_59();
        this.gfx_BG.targeting.hl.gotoAndStop(this.var_37.var_283);
    }
    ...
    @:allow(code) function method_46(param1:Int) {
        ...
        this.method_30();
        this.var_205.myProfile.saveInfo.needMoveSelected = true;
        if (this.var_205 != null) {
    ...
    @:allow(code) override function mouse_Down(param1:MouseEvent = null):Bool {
        ...
        if (this.contains(ASCompat.dynamicAs(param1.target, DisplayObject))) {
            if (Std.is(param1.target, DisplayObject)) {
                ...
                if (this.gfx_BG.targeting.contains(_loc2_)) {
                    return this.method_308(_loc2_.name);
                }
    ...
    @:allow(code) function method_63():Bool {
    ...
    @:allow(code) function method_308(param1:String):Bool {
        if (param1.length > 2) {
            return false;
        }
        var _loc2_ = ASCompat.toInt(param1.charAt(1));
        this.gfx_BG.targeting.hl.gotoAndStop(_loc2_);
        this.var_37.var_283 = _loc2_;
        this.var_37.saveInfo.var_646 = true;
        return true;
    }
    ...
    @:allow(code) function method_33(param1:Bool = false):Bool {
        this.var_450.method_245(this.var_205, param1);
