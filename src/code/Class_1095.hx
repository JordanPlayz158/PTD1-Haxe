...
class Class_1095 extends Class_877 {
    ...
    @:allow(code) override function mouse_Down(param1:MouseEvent = null):Bool {
        ...
        if (param1.target != null && Std.is(param1.target, GfxMovieClip)) {
            ...
            if (_loc2_.name == "butt_next") {
                ...
                if (false) {
                    _loc3_ = Std.downcast(this.var_3, Class_964);
                ...
                if (false) {
                    _loc3_ = Std.downcast(this.var_3, Class_964);
                    _loc4_ = new Class_967(this.var_3.currentProfile, this.var_3.my_Parent, _loc3_.var_68);
                    send_Msg(["change_Screen", _loc4_]);
                    return true;
                }
                if (false) {
                    _loc3_ = Std.downcast(this.var_3, Class_964);
                    _loc4_ = new Class_1118(this.var_3.currentProfile, this.var_3.my_Parent, _loc3_.var_68);
                    send_Msg(["change_Screen", _loc4_]);
                    return true;
                }
                if (false) {
                    _loc3_ = Std.downcast(this.var_3, Class_964);
                    _loc4_ = new Class_966(this.var_3.currentProfile, this.var_3.my_Parent, _loc3_.var_68);
                    send_Msg(["change_Screen", _loc4_]);
                    return true;
                }
                gfx.play();
    ...
    @:allow(code) override function get_Graphic():GfxMovieClip {
        return new Movie_Scene_Intro_17_Space_6();
    }
