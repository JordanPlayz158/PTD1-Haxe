...
class Class_1021 extends Class_877 {


    @:allow(code) var var_49:GfxMovieClip;

    @:allow(code) var var_3:Class_924;

    public function new(param1:Class_924) {
        this.var_3 = param1;
        super(param1);
    }
    ...
    @:allow(code) override function init() {
        ...
        if (!this.var_3.var_334) {
            ...
            _loc1_.inventory.push(Class_13.const_200);
        }
    }
    ...
    @:allow(code) override function get_Graphic():GfxMovieClip {
        return new Movie_Scene_Level_27_Win();
    }
