...
class Class_276 extends Class_16 {
    ...
    @:allow(code) override function remove_Me() {
        ...
        if (this.var_14.check_Effects(Class_810) == null) {
            ...
            if (_loc2_ <= 10) {
                _loc3_ = this.var_14.check_Effects(Class_803);
                if (_loc3_) {
                    _loc4_ = new Class_22(Class_22.const_11);
                    _loc3_.remove_Me();
                }
                else {
                    this.var_14.add_Effect(new Class_810(this.var_14, Class_276.name_1));
                    this.var_14.add_Effect(new Class_205(this.var_14, 6723840, 0.5, Class_276.name_1));
                }
            }
        }
