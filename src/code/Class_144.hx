...
import openfl.*;
import compat.*;
class Class_144 extends Attack {


    static inline final name_1 = Std.int(72.0);

    static inline final name_2 = Std.int(144.0);
    ...
    @:allow(code) override function do_Attack(param1:Poke) {
        ...
        while (_loc5_ < _loc2_.length) {
            ...
            if (!_loc3_.check_Effects(Class_806)) {
                _loc4_ = true;
                if (_loc6_ = _loc3_.check_Effects(Class_809)) {
                    _loc7_ = new Class_22(Class_22.const_17);
                    _loc6_.remove_Me();
                }
                else {
                    _loc3_.add_Effect(new Class_806(_loc3_, Class_144.name_1));
                    _loc3_.add_Effect(new Class_197(_loc3_, new Do_Tailwind()));
                }
            }
            _loc5_++;
        }
