...
import openfl.*;
import compat.*;
class Class_155 extends Attack {
    ...
    @:allow(code) override function do_Attack(param1:Poke) {
        ...
        param1.add_Effect(new Class_792(param1, Class_155.name_1));
        param1.add_Effect(new Class_205(param1, 16777215, 0.3, Class_155.name_1));
        param1.add_Effect(new Class_823(param1, Class_155.name_1));
    }

    @:allow(code) override function get_My_Attack_Animation():Class_16 {
        var_2.add_Effect(new Class_197(var_2, new Do_Gravity()));
