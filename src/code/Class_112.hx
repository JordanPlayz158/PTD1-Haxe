...
import openfl.*;
import compat.*;
class Class_112 extends Attack {
    ...
    @:allow(code) override function do_Attack(param1:Poke) {
        ...
        param1.add_Effect(new Class_792(param1, Class_112.name_1));
        param1.add_Effect(new Class_205(param1, 16777215, 0.3, Class_112.name_1));
        param1.add_Effect(new Class_813(param1, Class_112.name_1));
    }
