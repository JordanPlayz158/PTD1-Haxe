...
import openfl.*;
import compat.*;
class Class_146 extends Attack {
    ...
    @:allow(code) override function do_Attack(param1:Poke) {
        ...
        while (_loc5_ < _loc2_.length) {
            ...
            if (!_loc3_.check_Effects(Class_818)) {
                _loc4_ = true;
                _loc3_.add_Effect(new Class_818(_loc3_, Attack.ATTACK_TIME));
                _loc3_.take_Healing(_loc3_.totalLife);
            }
            _loc5_++;
        }
