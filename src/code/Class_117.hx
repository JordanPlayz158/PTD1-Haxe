...
import openfl.*;
import compat.*;
class Class_117 extends Attack {
    ...
    @:allow(code) override function do_Attack(param1:Poke) {
        ...
        var_2.add_Effect(new Class_803(var_2, Class_117.name_1));
        var_2.add_Effect(new Class_197(var_2, new Do_Amnesia()));
    }
