...
class Class_1085 extends Class_877 {
    ...
    @:allow(code) override function mouse_Down(param1:MouseEvent = null):Bool {
        ...
        if (param1.target != null && Std.is(param1.target, GfxMovieClip)) {
            ...
            if (_loc2_.name == "butt_next") {
                ...
                if (false) {
                    _loc3_ = Std.downcast(this.var_3, Class_959);
                    _loc4_ = new Class_961(this.var_3.currentProfile, this.var_3.my_Parent, _loc3_.var_68);
                ...
                if (false) {
                    _loc3_ = Std.downcast(this.var_3, Class_959);
                    _loc4_ = new Class_956(this.var_3.currentProfile, this.var_3.my_Parent, _loc3_.var_68);
                    send_Msg(["change_Screen", _loc4_]);
                    return true;
                }
                gfx.play();
    ...
    @:allow(code) override function get_Graphic():GfxMovieClip {
        return new Movie_Scene_Intro_17_Space_3();
    }
