...
class Class_900 extends _Obj {


    static inline final const_284 = 6;
    ...
    @:allow(code) function init() {
        ...
        this.gfx_BG = new Gfx_Screen_Challenge_Level_Select();
    ...
    @:allow(code) function method_19() {
        ...
        var _loc2_ = 1;
        while (_loc2_ <= Class_900.const_284) {
            _loc1_ = (this.var_59 : ASAny)["level" + _loc2_];
            if (this.currentProfile.clevelCompleted < _loc2_ - 1) {
    ...
    @:allow(code) function method_110():_Obj {
        var _loc1_:ASAny = null;
        if (this.var_34 == 1) {
            _loc1_ = new Class_951(this.currentProfile, my_Parent);
        }
        else if (this.var_34 == 2) {
            _loc1_ = new Class_949(this.currentProfile, my_Parent);
        }
        else if (this.var_34 == 3) {
            _loc1_ = new Class_950(this.currentProfile, my_Parent);
        }
        else if (this.var_34 == 4) {
            _loc1_ = new Class_893(4, this.currentProfile, my_Parent, true, -1, true);
        }
        else if (this.var_34 == 5) {
            _loc1_ = new Class_893(5, this.currentProfile, my_Parent, true, -1, true);
        }
        else if (this.var_34 == 6) {
            _loc1_ = new Class_952(this.currentProfile, my_Parent);
        }
        return _loc1_;
    }
    ...
    @:allow(code) override function mouse_Down(param1:MouseEvent = null):Bool {
        ...
        if (Std.is(param1.target, GfxMovieClip)) {
            ...
            _loc5_ = 1;
            while (_loc5_ <= Class_900.const_284) {
