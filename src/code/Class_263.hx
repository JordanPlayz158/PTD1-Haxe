...
class Class_263 extends Class_16 {
    ...
    @:allow(code) override function remove_Me() {
        ...
        Attack.lower_Defense(this.var_8, 1800);
        Attack.lower_Special_Defense(this.var_8, 1800);
        Attack.lower_Speed(this.var_8, 1800);
        var_1 = null;
    }
}
