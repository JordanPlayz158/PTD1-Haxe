...
class Class_331 extends Class_16 {
    ...
    @:allow(code) override function run() {
        ...
        if (this.var_388.length == 0) {
            Attack.do_Flinch(this.var_14, 100, 0, var_1, null, 1, false);
            Attack.lower_Speed(this.var_14, 0);
            this.remove_Me();
            return;
        }
