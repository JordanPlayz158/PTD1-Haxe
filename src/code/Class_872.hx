...
import openfl.*;
import compat.*;
class Class_872 extends Class_853 {
    ...
    public function new(param1:Class_875, param2:Int, param3:Float, param4:Poke) {
        this.var_20 = param2;
        this.var_12 = param3;
        super(param1, new Do_Stealth_Rock_Path(), 0, param4);
    }

    @:allow(code) override function onCollision(param1:Poke) {
        if (param1.check_Effects(Class_849) == null) {
            if (Std.is(var_65, Class_1104)) {
                param1.method_18(cast(var_65, Class_1104));
            }
            param1.add_Effect(new Class_849(param1, Attack.ATTACK_TIME));
