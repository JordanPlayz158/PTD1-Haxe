...
import openfl.*;
import compat.*;
class Class_115 extends Attack {
    ...
    @:allow(code) override function do_Attack(param1:Poke) {
        ...
        var_2.add_Effect(new Class_205(var_2, 52479, 0.7, Class_115.name_1));
        var_2.add_Effect(new Class_805(var_2, Class_115.name_1));
    }
