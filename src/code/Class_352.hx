...
class Class_352 extends Class_16 {
    ...
    @:allow(code) override function run() {
        ...
        if (this.var_512 < this.var_564) {
            this.gfx = new Hit_Sludge();
            this.gfx.scaleX = this.gfx.scaleY = 1.5;
    ...
    @:allow(code) override function remove_Me() {
        ...
        Attack.method_161(this.var_14, 30, var_1, null, this.var_306, var_12, true);
