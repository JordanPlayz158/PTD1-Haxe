...
class Class_888 extends _Obj {


    static inline final const_284 = 42;

    static inline final const_291 = 37;
    ...
    @:allow(code) function init() {
        this.gfx_BG = new Gfx_Screen_Level_Select_Chapter_8();
    ...
    @:allow(code) function method_19() {
        ...
        var _loc2_ = Class_888.const_291;
        while (_loc2_ <= Class_888.const_284) {
            _loc1_ = (this.var_59 : ASAny)["level" + _loc2_];
            if (this.currentProfile.levelUnlocked < _loc2_ - 1 && _loc2_ > 39) {
    ...
    @:allow(code) override function mouse_Down(param1:MouseEvent = null):Bool {
        ...
        if (Std.is(param1.target, GfxMovieClip)) {
            ...
            _loc5_ = Class_888.const_291;
            while (_loc5_ <= Class_888.const_284) {
