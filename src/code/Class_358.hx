...
class Class_358 extends Class_16 {
    ...
    @:allow(code) override function run() {
        ...
        if (this.var_512 < this.var_564 && var_15 == 0) {
            this.gfx = new Do_Sting_Ice();
            this.gfx.scaleX = this.gfx.scaleY = 2;
        ...
        while (_loc3_ < this.var_388.length) {
            ...
            if (this.gfx.y == this.var_284.y && this.gfx.x == this.var_284.x || _loc1_ && _loc2_) {
                ...
                Attack.do_Flinch(this.var_14, 30, Attack.ATTACK_TIME, var_1, null, var_12, true);
                _loc3_--;
            }
            else {
