...
import openfl.*;
import compat.*;
class Class_143 extends Attack {
    ...
    @:allow(code) override function do_Attack(param1:Poke) {
        ...
        var_2.add_Effect(new Class_197(var_2, new Do_Barrier()));
        var_2.add_Effect(new Class_808(var_2, Class_143.name_1));
    }
