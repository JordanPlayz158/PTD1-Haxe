...
class Class_1063 extends Class_877 {


    @:allow(code) var var_49:GfxMovieClip;

    @:allow(code) var var_3:Class_946;
    ...
    @:allow(code) function method_54():Int {
        ...
        if (_loc2_ == 6) {
            this.var_3.currentProfile.inventory.push(251);
            return 1;
        }
        if (_loc3_ == 6) {
            this.var_3.currentProfile.inventory.push(252);
            return 2;
        }
        this.var_3.currentProfile.inventory.push(25);
        return 0;
    }

    @:allow(code) override function get_Graphic():GfxMovieClip {
        return new Movie_Scene_Level_37_Win();
    }
