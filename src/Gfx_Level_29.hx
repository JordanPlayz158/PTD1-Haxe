...
/*dynamic*/ class Gfx_Level_29 extends GfxMovieClip {


    public var wp_1_back_left:GfxMovieClip;

    public var wp_0_right_left:GfxMovieClip;

    

    public var wp_3_front_left:GfxMovieClip;

    public var spot_10:GfxMovieClip;

    public var spot_1:GfxMovieClip;

    public var wp_2_right_front:GfxMovieClip;

    public var spot_11:GfxMovieClip;

    public var spot_2:GfxMovieClip;

    public var wp_5_right_left:GfxMovieClip;
    ...
    public var wp_4_right_back:GfxMovieClip;
