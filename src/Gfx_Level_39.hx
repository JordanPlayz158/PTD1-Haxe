...
/*dynamic*/ class Gfx_Level_39 extends GfxMovieClip {


    public var wp_1_left_back:GfxMovieClip;

    public var wp_3_right_back:GfxMovieClip;

    public var wp_4_front_left:GfxMovieClip;

    public var wp_2_front_right:GfxMovieClip;
    ...
    public var wp_5_front_back:GfxMovieClip;
