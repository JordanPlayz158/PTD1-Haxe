...
/*dynamic*/ class Gfx_Level_25 extends GfxMovieClip {
    ...
    public var w2_1_back_left:GfxMovieClip;
    ...
    public var wp_3_left_right:GfxMovieClip;
    ...
    public var w2_3_left_right:GfxMovieClip;

    public var w2_2_left_front:GfxMovieClip;

    public var spot_5:GfxMovieClip;

    public var spot_6:GfxMovieClip;

    public var wp_2_left_back:GfxMovieClip;
