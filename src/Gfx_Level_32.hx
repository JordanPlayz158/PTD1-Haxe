...
/*dynamic*/ class Gfx_Level_32 extends GfxMovieClip {
    ...
    public var wp_2_right_left:GfxMovieClip;

    public var spot_10:GfxMovieClip;

    public var spot_1:GfxMovieClip;

    public var w2_1_right_back:GfxMovieClip;
    ...
    public var w2_2_right_left:GfxMovieClip;
