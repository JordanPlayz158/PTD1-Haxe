...
class Color extends ColorTransform {
    ...
    var _tintColor:Float = 0;

    var _tintMultiplier:Float = 0;

    public function new(param1:Float = 1.0, param2:Float = 1.0, param3:Float = 1.0, param4:Float = 1.0, param5:Float = 0, param6:Float = 0, param7:Float = 0, param8:Float = 0) {
        super(param1, param2, param3, param4, param5, param6, param7, param8);
    }

    public static function fromXML(param1:compat.compat.XML):Color {
        return new Color().parseXML(param1);
    }
    ...
    public var tintColor(get, set):UInt;
    ...
    function parseXML(param1:compat.compat.XML = null):Color {
        ...
        // param1.elements()[0];
        var _loc2_:compat.compat.XMLList = param1.children().child("0");
        if (_loc2_ == null) {
            return this;
        }
        for (_tmp_ in _loc2_.iterator()) {
            _loc3_ = _tmp_;
            if ((_loc4_ = _loc3_.localName()) == "tintColor") {
                _loc5_ = Std.int(ASCompat.toNumber(Std.string(_loc3_)));
                this.tintColor = _loc5_;
            }
            else {
                (this : ASAny)[_loc4_] = ASCompat.toNumber(Std.string(_loc3_));
            }
        }
        return this;
    }
