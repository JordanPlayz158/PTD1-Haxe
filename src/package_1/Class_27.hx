...
class Class_27 extends Class_7 {
    ...
    override public function do_Wave() {
        if (var_6 == 1) {
            my_Parent.add_Enemy_Poke(method_1(Class_27.const_52, Class_27.const_193));
            if (var_5 < 3) {
                var_11 = 24;
            }
            else {
            ...
            my_Parent.add_Enemy_Poke(method_1(Class_27.const_52, Class_27.const_193), 1, "2");
            if (var_5 < 3) {
                var_11 = 24;
            }
            else {
            ...
            my_Parent.add_Enemy_Poke(method_1(Class_27.const_52, Class_27.const_193), 1, "3");
            if (var_5 < 3) {
                var_11 = 24;
            }
            else {
            ...
            my_Parent.add_Enemy_Poke(method_1(Class_27.const_52, Class_27.const_193), 1, "4");
            if (var_5 < 3) {
                var_11 = 24;
            }
            else {
            ...
            my_Parent.add_Enemy_Poke(method_1(Class_27.const_224));
            if (var_5 < 5) {
                var_11 = 24;
            }
            else {
            ...
            my_Parent.add_Enemy_Poke(method_1(Class_27.const_224), 1, "2");
            if (var_5 < 5) {
                var_11 = 24;
            }
            else {
            ...
            my_Parent.add_Enemy_Poke(method_1(Class_27.const_236), 1, "3");
            if (var_5 < 5) {
                var_11 = 24;
            }
            else {
            ...
            my_Parent.add_Enemy_Poke(method_1(Class_27.const_236), 1, "4");
            if (var_5 < 5) {
                var_11 = 24;
            }
            else {
            ...
            my_Parent.add_Enemy_Poke(method_1(Class_27.const_196));
            my_Parent.add_Enemy_Poke(method_1(Class_27.const_196), 1, "2");
            method_4(++var_6);
            var_11 = 300;
            var_5 = 0;
        }
        else if (var_6 == 13) {
            my_Parent.add_Enemy_Poke(method_1(Class_27.const_231), 1, "3");
            my_Parent.add_Enemy_Poke(method_1(Class_27.const_231), 1, "4");
            method_4(++var_6);
            var_11 = 300;
            var_5 = 0;
        }
            ...
            my_Parent.add_Enemy_Poke(method_1(Class_27.const_194));
            my_Parent.add_Enemy_Poke(method_1(Class_27.const_194), 1, "2");
            method_4(++var_6);
            var_11 = 300;
            var_5 = 0;
        }
        else if (var_6 == 16) {
            my_Parent.add_Enemy_Poke(method_1(Class_27.const_233), 1, "3");
            my_Parent.add_Enemy_Poke(method_1(Class_27.const_233), 1, "4");
            method_4(++var_6);
            var_11 = 300;
            var_5 = 0;
        }
            ...
            my_Parent.add_Enemy_Poke(method_1(Class_27.const_223));
            my_Parent.add_Enemy_Poke(method_1(Class_27.const_223), 1, "2");
            method_4(++var_6);
            var_11 = 60;
            var_5 = 0;
        }
        else if (var_6 >= 29 && var_6 <= 39) {
            my_Parent.add_Enemy_Poke(method_1(Class_27.const_245), 1, "3");
            my_Parent.add_Enemy_Poke(method_1(Class_27.const_245), 1, "4");
            method_4(++var_6);
            var_11 = 60;
            var_5 = 0;
        }
    ...
    override public function get_Poke_Profile(param1:Int = 0, param2:Int = 0, param3:Int = 0):Class_6 {
        ...
        if (param1 == Class_27.const_52) {
            ...
            else if (param2 <= Class_27.const_226) {
            ...
            else if (param2 <= Class_27.const_235) {
            ...
            else if (param2 <= Class_27.const_363) {
            ...
            else if (param2 <= Class_27.const_337) {
            ...
            else if (param2 <= Class_27.const_234) {
        ...
        else if (param1 == Class_27.const_223) {
        ...
        else if (param1 == Class_27.const_224) {
        ...
        else if (param1 == Class_27.const_231) {
        ...
        else if (param1 == Class_27.const_233) {
        ...
        else if (param1 == Class_27.const_270) {
        ...
        else if (param1 == Class_27.const_196) {
        ...
        else if (param1 == Class_27.const_236) {
        ...
        else if (param1 == Class_27.const_245) {
            _loc4_.num = Class_13.const_21;
            Class_13.method_2(_loc4_);
            _loc4_.level = 28 + _loc5_;
        ...
        else if (param1 == Class_27.const_194) {
