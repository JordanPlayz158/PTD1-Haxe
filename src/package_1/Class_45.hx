...
class Class_45 extends Class_7 {
    ...
    override public function do_Wave() {
        ...
        _loc1_ = 6;
        if (var_6 == 1) {
            my_Parent.add_Enemy_Poke(method_1(Class_45.const_211), 1.5);
            var_11 = 150;
            method_4(++var_6);
            return;
        }
        if (var_6 == 2) {
            my_Parent.add_Enemy_Poke(method_1(Class_45.const_52), 1, "2");
            var_11 = 21;
            if (var_5 == _loc1_) {
                method_4(++var_6);
                var_11 = 60;
            ...
            if (var_6 == 3) {
                my_Parent.add_Enemy_Poke(method_1(Class_45.const_204), 1.5, "2");
                var_11 = 150;
                method_4(++var_6);
                return;
            }
            if (var_6 == 4) {
                my_Parent.add_Enemy_Poke(method_1(Class_45.const_227), 1);
                var_11 = 21;
                if (var_5 == _loc1_) {
                    method_4(++var_6);
                    var_11 = 150;
    ...
    override public function get_Poke_Profile(param1:Int = 0, param2:Int = 0, param3:Int = 0):Class_6 {
        ...
        if (param1 == Class_45.const_52) {
            if (param2 == 0) {
                param2 = Std.int(Math.random() * 100 + 1);
            }
            if (param2 <= Class_45.const_226) {
                if (param3 == 0) {
                    param3 = Std.int(26 + Math.random() * 5);
                }
                _loc4_.level = param3;
            ...
            else if (param2 <= Class_45.const_363) {
                if (param3 == 0) {
                    param3 = Std.int(26 + Math.random() * 5);
                }
                _loc4_.level = param3;
            ...
            else if (param2 <= Class_45.const_347) {
                if (param3 == 0) {
                    param3 = Std.int(28 + Math.random() * 3);
                }
                _loc4_.level = param3;
            ...
            else if (param2 <= Class_45.const_337) {
                if (param3 == 0) {
                    param3 = Std.int(24 + Math.random() * 7);
                }
                _loc4_.level = param3;
        ...
        else if (param1 == Class_45.const_227) {
            if (param2 == 0) {
                param2 = Std.int(Math.random() * 100 + 1);
            }
            if (param2 <= Class_45.const_234) {
                if (param3 == 0) {
                    param3 = Std.int(25 + Math.random() * 4);
                }
                _loc4_.level = param3;
            ...
            else if (param2 <= Class_45.const_193) {
                if (param3 == 0) {
                    param3 = Std.int(25 + Math.random() * 3);
                }
                _loc4_.level = param3;
            ...
            else if (param2 <= Class_45.const_394) {
                _loc4_.level = 26;
        ...
        else if (param1 == Class_45.const_204) {
            _loc4_.num = Class_13.const_12;
            Class_13.method_2(_loc4_);
            _loc4_.level = 36;
            _loc4_.move1 = Class_9.var_88;
        ...
        else if (param1 == Class_45.const_211) {
            _loc4_.num = Class_13.const_12;
            Class_13.method_2(_loc4_);
            _loc4_.level = 36;
            _loc4_.move1 = Class_9.var_136;
