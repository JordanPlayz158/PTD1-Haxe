...
class Class_81 extends Class_7 {
    ...
    override public function do_Wave() {
        if (var_5 == 6) {
            my_Parent.add_Enemy_Poke(method_1(Class_81.const_52));
            if (var_6 == 20) {
                var_6 = 21;
                wave_Finished();
                return;
        ...
        if (var_5 == 1 || var_5 == 3) {
            my_Parent.add_Enemy_Poke(method_1(0, Class_81.const_230));
        }
        else {
            my_Parent.add_Enemy_Poke(method_1(0, Class_81.const_230), 1, "2");
        }
        var_11 = 21;
        ++var_5;
    }
    ...
    override public function get_Poke_Profile(param1:Int = 0, param2:Int = 0, param3:Int = 0):Class_6 {
        ...
        _loc4_ = new Class_6();
        if (param1 == Class_81.const_52) {
            if (param2 == 0) {
                param2 = Std.int(Math.random() * 1000 + 1);
            }
            method_11(_loc4_);
            if (param2 <= Class_81.const_234) {
            ...
            else if (param2 <= Class_81.const_193) {
            ...
            else if (param2 <= Class_81.const_232) {
            ...
            else if (param2 <= Class_81.const_230) {
            ...
            else if (param2 <= Class_81.const_240) {
